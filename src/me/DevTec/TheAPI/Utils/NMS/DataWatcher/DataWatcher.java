...
public class DataWatcher {
	...
	public DataWatcher(Object entity) {
		w = Reflections.c(
				Reflections.getConstructor(Reflections.getNMSClass("DataWatcher"), Reflections.getNMSClass("Entity")),
				entity);
	}
	...
	public Object get(DataWatcherObject dataWatcherObject) {
		return Reflections.invoke(w,
				Reflections.getMethod(w.getClass(), "get", Reflections.getNMSClass("DataWatcherObject")),
	...
	public void set(DataWatcherObject dataWatcherObject, Object data) {
		Reflections.invoke(w,
				Reflections.getMethod(w.getClass(), "a", Reflections.getNMSClass("DataWatcherObject"), Object.class),
				dataWatcherObject.get(), data);
	}

	public void register(DataWatcherObject dataWatcherObject, Object data) {
		Reflections.invoke(w, Reflections.getMethod(w.getClass(), "register",
				Reflections.getNMSClass("DataWatcherObject"), Object.class), dataWatcherObject.get(), data);
	}
}
