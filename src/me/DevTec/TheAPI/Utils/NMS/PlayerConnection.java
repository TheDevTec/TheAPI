...
public class PlayerConnection {
	...
	public void teleport(Location destination) {
		Reflections.invoke(a, Reflections.getMethod(Reflections.getNMSClass("PlayerConnection"),"teleport", Location.class),destination);
	}

	public void disconnect(String reason) {
		Reflections.invoke(a, Reflections.getMethod(Reflections.getNMSClass("PlayerConnection"),"disconnect", String.class),reason);
	}

	public void chat(String message, boolean async) {
		Reflections.invoke(a, Reflections.getMethod(Reflections.getNMSClass("PlayerConnection"),"chat", String.class, boolean.class),message,async);
	}

	public NetworkManager getNetworkManager() {
		return new NetworkManager(Reflections.get(Reflections.getField(Reflections.getNMSClass("PlayerConnection"), "networkManager"),a));
	}
