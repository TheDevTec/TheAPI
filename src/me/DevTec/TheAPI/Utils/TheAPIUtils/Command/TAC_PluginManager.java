...
public class TAC_PluginManager {
	...
	public TAC_PluginManager(CommandSender s, String[] args) {
		...
		if (args[1].equalsIgnoreCase("Load")) {
			...
			if (PluginManagerAPI.getRawPluginsToLoad().contains(pluginName)
					|| PluginManagerAPI.getRawPluginsToLoad().contains(pluginName + ".jar")
					|| PluginManagerAPI.getPluginsToLoad().contains(pluginName)
					|| PluginManagerAPI.getPluginsToLoad().contains(pluginName + ".jar")) {
				...
				String real = null;
				for (Plugin a : PluginManagerAPI.getPlugins())
					if (a.getName().equals(pluginName)
							|| PluginManagerAPI.getFileOfPlugin(a).getName().equals(pluginName)
