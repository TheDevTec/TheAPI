...
public class Player {
	...
	public void sendActionBar(String text) {
		getPlayerConnection().sendPacket(TheAPI.getNMSAPI().getPacketPlayOutTitle(TitleAction.ACTIONBAR, TheAPI.colorize(text)));
	}
	
	public void setTabList(String header, String footer) {
		getPlayerConnection().sendPacket(TheAPI.getNMSAPI().getPacketPlayOutPlayerListHeaderFooter(TheAPI.colorize(header), TheAPI.colorize(footer)));
	}
	
	public void sendTitle(String title, String subtitle) {
		getPlayerConnection().sendPacket(TheAPI.getNMSAPI().getPacketPlayOutTitle(TitleAction.TITLE, TheAPI.colorize(title)));
		getPlayerConnection().sendPacket(TheAPI.getNMSAPI().getPacketPlayOutTitle(TitleAction.SUBTITLE, TheAPI.colorize(subtitle)));
	}
	...
	public void damage(double damage) {
		Reflections.processMethod(a, "damageEntity", Reflections.getField(Reflections.getNMSClass("DamageSource"),"GENERIC"),damage);
	}
	...
	public PlayerInventory getInventory() {
		return (PlayerInventory)Reflections.c(Reflections.getConstructor(Reflections.getBukkitClass("inventory.CraftInventoryPlayer"),Reflections.getNMSClass("PlayerInventory")),Reflections.get(a, "inventory"));
	}
	public void setInventory(PlayerInventory a) {
		Reflections.setField(a, "inventory", Reflections.cast(Reflections.getNMSClass("PlayerInventory"), Reflections.cast(Reflections.getBukkitClass("inventory.CraftInventoryPlayer"), a)));
	}
