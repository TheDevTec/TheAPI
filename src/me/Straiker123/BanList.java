...
public class BanList {
	...
	public List<String> getIPBanned() {
		...
		for(String s : c.getKeys("banip"))list.add(s);
		return list;
	}

	public List<String> getBanned() {
		ArrayList<String> list = Lists.newArrayList();
		for(String s : c.getKeys("ban"))list.add(s);
		return list;
	}

	public List<String> getMuted() {
		ArrayList<String> list = Lists.newArrayList();
		for(String s : c.getKeys("mute"))list.add(s);
		return list;
	}

	public List<String> getJailed() {
		ArrayList<String> list = Lists.newArrayList();
		for(String s : c.getKeys("jail"))list.add(s);
		return list;
	}
