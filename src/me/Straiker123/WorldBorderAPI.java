	...
	public void remove(double size, long time) {
		try {
			...
			if (remove > 0)
				...
				Error.err("set world border size of world " + w.getName() + " to " + remove,
	...
	public void setDamageAmount(double amount) {
		try {
			if (amount > 0)
				...
				Error.err("set world border damage of world " + w.getName() + " to " + amount,
	...
	public void setDamageBuffer(double amount) {
		try {
			if (amount > 0)
				...
				Error.err("set world border buffer of world " + w.getName() + " to " + amount,
	...
	public void setWarningDistance(int distance) {
		try {
			if (distance > 0)
				...
				Error.err("set world border warning distance of world " + w.getName() + " to " + distance,
	...
	public void setWarningTime(int time) {
		try {
			if (time > 0)
				...
				Error.err("set world border warning time of world " + w.getName() + " to " + time,
