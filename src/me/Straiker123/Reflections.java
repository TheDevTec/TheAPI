...
public class Reflections {
	...
	public static void processMethod(Object main, String method,Object value, Object value2, Object value3, Object value4) {
		try {
			main.getClass().getMethod(method, value.getClass(),value2.getClass(),value3.getClass(),value4.getClass()).invoke(main,value,value2,value3,value4);
		} catch (Exception e) {
			e.printStackTrace();
		}
	}
	...
	public static void processMethod(Object main, String method,Object value, Object value2, Object value3) {
		try {
			main.getClass().getMethod(method, value.getClass(),value2.getClass(),value3.getClass()).invoke(main,value,value2,value3);
		} catch (Exception e) {
			e.printStackTrace();
		}
	}
	...
	public static Object get(Object main, String field) {
		try {
			...
			return f.get(main);
				...
				if(m==null)m = main.getClass().getDeclaredMethod(field);
				if(m!=null)
