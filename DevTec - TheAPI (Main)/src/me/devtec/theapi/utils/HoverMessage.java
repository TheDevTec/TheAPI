...
public class HoverMessage {
	...
	public String getJson() {
		...
		m.add(0, "");
		return Json.writer().simpleWrite(m);
	}
	...
	public void send(Collection<Player> players) {
		Ref.sendPacket(players, LoaderClass.nmsProvider.packetChat(me.devtec.theapi.utils.nms.NmsProvider.ChatType.SYSTEM, LoaderClass.nmsProvider.chatBase(getJson())));
	}

	public void send(Player player) {
		Ref.sendPacket(player, LoaderClass.nmsProvider.packetChat(me.devtec.theapi.utils.nms.NmsProvider.ChatType.SYSTEM, LoaderClass.nmsProvider.chatBase(getJson())));
	}
}
