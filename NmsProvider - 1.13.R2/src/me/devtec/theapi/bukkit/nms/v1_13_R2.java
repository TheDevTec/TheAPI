...
public class v1_13_R2 implements NmsProvider {
	...
	public int getEntityId(Object entity) {
		return ((net.minecraft.server.v1_13_R2.Entity)entity).getId();
	}
	...
	public Object getNBT(ItemStack itemStack) {
		return ((net.minecraft.server.v1_13_R2.ItemStack)asNMSItem(itemStack)).getOrCreateTag();
	}
	...
	public ItemStack setNBT(ItemStack stack, Object nbt) {
		...
		net.minecraft.server.v1_13_R2.ItemStack i = (net.minecraft.server.v1_13_R2.ItemStack)asNMSItem(stack);
	...
	public Object asNMSItem(ItemStack stack) {
		if(stack==null)return net.minecraft.server.v1_13_R2.ItemStack.a;
		return CraftItemStack.asNMSCopy(stack);
	}

	@Override
	public ItemStack asBukkitItem(Object stack) {
		return CraftItemStack.asBukkitCopy((net.minecraft.server.v1_13_R2.ItemStack) stack);
	}
	...
	public Object packetSetSlot(int container, int slot, int stateId, Object itemStack) {
		return new PacketPlayOutSetSlot(container, slot, (net.minecraft.server.v1_13_R2.ItemStack)(itemStack==null?asNMSItem(null):itemStack));
	}
	...
	public Object packetEntityMetadata(int entityId, Object dataWatcher, boolean bal) {
		return new PacketPlayOutEntityMetadata(entityId, (net.minecraft.server.v1_13_R2.DataWatcher) dataWatcher, bal);
	}
	...
	public Object packetSpawnEntity(Object entity, int id) {
		return new PacketPlayOutSpawnEntity((net.minecraft.server.v1_13_R2.Entity) entity, id);
	}
	...
	public Chunk toBukkitChunk(Object nmsChunk) {
		return ((net.minecraft.server.v1_13_R2.Chunk)nmsChunk).bukkitChunk;
	}
	...
	public void setSlot(Object container, int slot, Object item) {
		((Container)container).setItem(slot, (net.minecraft.server.v1_13_R2.ItemStack)item);
	}
	...
	public void setGUITitle(Player player, Object container, String legacy, int size, String title) {
		...
		NonNullList<net.minecraft.server.v1_13_R2.ItemStack> nmsItems = ((Container)container).items;
		BukkitLoader.getPacketHandler().send(player, packetOpenWindow(id,legacy,size,title));
		int i = 0;
		for(net.minecraft.server.v1_13_R2.ItemStack o : nmsItems) 
	...
	public void openGUI(Player player, Object container, String legacy, int size, String title, ItemStack[] items) {
		EntityPlayer nmsPlayer = ((CraftPlayer)player).getHandle();
		int id = ((Container)container).windowId;
		net.minecraft.server.v1_13_R2.ItemStack[] nmsItems = new net.minecraft.server.v1_13_R2.ItemStack[items.length];
		for(int i = 0; i < items.length; ++i) {
			ItemStack is = items[i];
			if(is==null||is.getType()==Material.AIR)continue;
			net.minecraft.server.v1_13_R2.ItemStack item = null;
			((Container)container).setItem(i,item=(net.minecraft.server.v1_13_R2.ItemStack) asNMSItem(is));
			nmsItems[i]=item;
		}
		BukkitLoader.getPacketHandler().send(player, packetOpenWindow(id,legacy,size,title));
		int i = 0;
	...
	public void openAnvilGUI(Player player, Object con, String title, ItemStack[] items) {
		...
		for(int i = 0; i < items.length; ++i) {
			...
			if(is==null||is.getType()==Material.AIR)continue;
			net.minecraft.server.v1_13_R2.ItemStack item = null;
			container.setItem(i,item=(net.minecraft.server.v1_13_R2.ItemStack) asNMSItem(is));
			nmsItems[i]=item;
		}
	...
	public Object createAnvilContainer(Inventory inv, Player player) {
		...
		for(int i = 0; i < 2; ++i)
			container.setItem(i, (net.minecraft.server.v1_13_R2.ItemStack) asNMSItem(inv.getItem(i)));
		return container;
	}
	...
	public boolean processInvClickPacket(Player player, HolderGUI gui, Object provPacket) {
	    ...
	    net.minecraft.server.v1_13_R2.InventoryClickType nmsType = packet.g();
		...
		if((type==InventoryClickType.QUICK_MOVE||type==InventoryClickType.CLONE||type==InventoryClickType.THROW||(item.getType()==Material.AIR||item.getType()==Material.CAVE_AIR)) && (item.getType()==Material.AIR||item.getType()==Material.CAVE_AIR))
	...
	public Object getDataWatcher(Object entity) {
		return ((net.minecraft.server.v1_13_R2.Entity)entity).getDataWatcher();
	}
	...
	public Object packetEntityHeadRotation(Entity entity) {
		return new PacketPlayOutEntityHeadRotation((net.minecraft.server.v1_13_R2.Entity) getEntity(entity), (byte)(entity.getLocation().getYaw()*256F/360F));
	}
	...
	public Object packetRespawn(Player player) {
		...
		return new PacketPlayOutRespawn(worldserver.dimension, worldserver.getDifficulty(), worldserver.getWorldData().getType(), entityPlayer.playerInteractManager.getGameMode());
	}

	@Override
	public String getProviderName() {
		return "1_13_R2 (1.13.2)";
	}
