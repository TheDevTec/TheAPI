...
public class v1_16_R3_Mohist implements NmsProvider {
	...
	private static Field tabHeader = Ref.field(SPlayerListHeaderFooterPacket.class, "field_179703_a"),
			tabFooter = Ref.field(SPlayerListHeaderFooterPacket.class, "field_179702_b");
	...
	public Object packetOpenWindow(int id, String legacy, int size, String title) {
		...
		return new SOpenWindowPacket(id, windowType,
	...
	public Object packetSetSlot(int container, int slot, int statusId, Object itemStack) {
		return new SSetSlotPacket(container, slot,
				(net.minecraft.item.ItemStack) (itemStack == null ? asNMSItem(null) : itemStack));
	}
	...
	public Object packetBlockChange(World world, Position position) {
		return new SChangeBlockPacket((BlockPos) position.getBlockPosition(),
				(net.minecraft.block.BlockState) position.getIBlockData());
	}

	@Override
	public Object packetBlockChange(World world, int x, int y, int z) {
		return new SChangeBlockPacket(new BlockPos(x, y, z),
				(net.minecraft.block.BlockState) getBlock(getChunk(world, x >> 4, z >> 4), x, y, z));
	}
	...
	public Object packetScoreboardDisplayObjective(int id, Object scoreboardObjective) {
		return new SDisplayObjectivePacket(id,
				scoreboardObjective == null ? null : (ScoreObjective) scoreboardObjective);
	}
	...
	public Object packetTitle(TitleAction action, String text, int fadeIn, int stay, int fadeOut) {
		return new STitlePacket(Type.valueOf(action.name()),
				(ITextComponent) toIChatBaseComponent(ComponentAPI.fromString(text)), fadeIn, stay, fadeOut);
	}
	...
	public void postToMainThread(Runnable runnable) {
		v1_16_R3_Mohist.server.func_213167_f(runnable);
	}
	...
	public Object toItem(TheMaterial material) {
		...
		return Item.func_150898_a(((CraftBlockData) Bukkit.createBlockData(material.getType(), material.getData() + ""))
	...
	public void setBlock(Object chunk, int x, int y, int z, Object IblockData, int data) {
		...
		if (((net.minecraft.block.BlockState) IblockData).func_177230_c() instanceof ITileEntityProvider) {
			TileEntity ent = ((ITileEntityProvider) ((net.minecraft.block.BlockState) IblockData).func_177230_c())
					.func_196283_a_(c.func_177412_p());
	...
	public Chunk toBukkitChunk(Object nmsChunk) {
		...
		return Bukkit
				.getWorld(chunk.func_177412_p().toString().substring(12, chunk.func_177412_p().toString().length() - 1))
				.getChunkAt(chunk.func_76632_l().field_77276_a, chunk.func_76632_l().field_77275_b);
	}
	...
	public void closeGUI(Player player, Object container, boolean closePacket) {
		if (closePacket)
			BukkitLoader.getPacketHandler().send(player,
					new SCloseWindowPacket(BukkitLoader.getNmsProvider().getContainerId(container)));
	...
	public void setSlot(Object container, int slot, Object item) {
		((net.minecraft.inventory.container.Container) container).func_75141_a(slot,
	...
	public void setGUITitle(Player player, Object container, String legacy, int size, String title) {
		...
		NonNullList<net.minecraft.item.ItemStack> nmsItems = ((net.minecraft.inventory.container.Container) container)
				.func_75138_a();
	...
	public void openGUI(Player player, Object container, String legacy, int size, String title, ItemStack[] items) {
		...
		for (int i = 0; i < items.length; ++i) {
			...
			((net.minecraft.inventory.container.Container) container).func_75141_a(i,
					item = (net.minecraft.item.ItemStack) asNMSItem(is));
			nmsItems[i] = item;
		}
		BukkitLoader.getPacketHandler().send(player, packetOpenWindow(id, legacy, size, title));
		int i = 0;
	...
	public Object createContainer(Inventory inv, Player player) {
		return inv.getType() == InventoryType.ANVIL ? createAnvilContainer(inv, player)
				: new CraftContainer(inv, ((CraftPlayer) player).getHandle(),
						(int) Ref.invoke(((CraftPlayer) player).getHandle(), "nextContainerCounterCB"));
	}
	...
	public boolean processServerListPing(String player, Object channel, Object packet) {
		...
		ServerListPingEvent event = new ServerListPingEvent(Bukkit.getOnlinePlayers().size(), Bukkit.getMaxPlayers(),
				players, Bukkit.getMotd(), ping.func_151316_d(),
				((InetSocketAddress) ((Channel) channel).remoteAddress()).getAddress(),
				ping.func_151322_c().func_151303_a(), ping.func_151322_c().func_151304_b());
	...
	public Object packetEntityHeadRotation(Entity entity) {
		return new SEntityHeadLookPacket((net.minecraft.entity.Entity) getEntity(entity),
	...
	public Object packetPlayerInfo(PlayerInfoType type, Player player) {
		return new SPlayerListItemPacket(SPlayerListItemPacket.Action.valueOf(type.name()),
				(ServerPlayerEntity) getPlayer(player));
	}
	...
	public Object packetRespawn(Player player) {
		...
		return new SRespawnPacket(worldserver.func_230315_m_(), worldserver.func_234923_W_(),
				BiomeManager.func_235200_a_(player.getWorld().getSeed()), pp.field_71134_c.func_241815_c_(),
				pp.field_71134_c.func_73081_b(), false, player.getWorld().getWorldType() == WorldType.FLAT, true);
	}
