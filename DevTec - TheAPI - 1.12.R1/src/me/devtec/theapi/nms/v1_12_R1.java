...
public class v1_12_R1 implements NmsProvider {
	...
	public Object packetSetSlot(Object container, int slot, Object itemStack) {
		return new PacketPlayOutSetSlot(((CraftContainer)container).windowId, slot, (net.minecraft.server.v1_12_R1.ItemStack)itemStack);
	}

	@Override
	public Object packetEntityMetadata(int entityId, DataWatcher dataWatcher, boolean bal) {
		return new PacketPlayOutEntityMetadata(entityId, (net.minecraft.server.v1_12_R1.DataWatcher) dataWatcher.getDataWatcher(), bal);
	}
	...
	public Object packetBlockChange(World world, Position position) {
		return new PacketPlayOutBlockChange((net.minecraft.server.v1_12_R1.World)getWorld(world), (BlockPosition)position.getBlockPosition());
	}

	@Override
	public Object packetBlockChange(World world, int x, int y, int z) {
		return new PacketPlayOutBlockChange((net.minecraft.server.v1_12_R1.World)getWorld(world), new BlockPosition(x,y,z));
	}
	...
	public Object getChunk(World world, int x, int z) {
		...
		net.minecraft.server.v1_12_R1.Chunk loaded = ((ChunkProviderServer)sworld.getChunkProvider()).getLoadedChunkAt(x, z);
		if(loaded==null) { //load chunk
			net.minecraft.server.v1_12_R1.Chunk chunk = ((ChunkProviderServer)sworld.getChunkProvider()).loadChunk(x, z);
			if(chunk!=null) {
