...
public class v1_11_R1 implements NmsProvider {
	...
	public Object packetSetSlot(Object container, int slot, Object itemStack) {
		return new PacketPlayOutSetSlot(((CraftContainer)container).windowId, slot, (net.minecraft.server.v1_11_R1.ItemStack)itemStack);
	}
	...
	public Object getChunk(World world, int x, int z) {
		...
		net.minecraft.server.v1_11_R1.Chunk loaded = ((ChunkProviderServer)sworld.getChunkProvider()).getLoadedChunkAt(x, z);
		if(loaded==null) { //load chunk
			net.minecraft.server.v1_11_R1.Chunk chunk = ((ChunkProviderServer)sworld.getChunkProvider()).loadChunk(x, z);
			if(chunk!=null) {
