...
import me.devtec.theapi.game.particles.ParticleData.BlockOptions;
import me.devtec.theapi.game.particles.ParticleData.ItemOptions;
import me.devtec.theapi.game.particles.ParticleData.NoteOptions;
import me.devtec.theapi.game.particles.ParticleData.RedstoneOptions;
	...
	public Object createPacket(double x, double y, double z, float speed, int amount) {
		...
		if (Ref.isNewerThan(12)) { // 1.13+
			...
			if (data != null) {
				...
				Ref.set(packet, "j", Ref.newInstance(paramItem, particle, BukkitLoader.getNmsProvider().asNMSItem(a.getItem())));
				return packet;
			}
			Ref.set(packet, "j", particle);
			return packet;
