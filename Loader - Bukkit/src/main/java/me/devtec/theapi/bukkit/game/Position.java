...
public class Position implements Cloneable {
    ...
    public boolean equals(Object a) {
        if (a instanceof Position) {
            ...
            return (world == null ? s.getWorldName() == null : world.equals(s.getWorldName())) && s.getX() == x && s.getY() == y && s.getZ() == z && s.getPitch() == pitch && s.getYaw() == yaw;
        }
        if (a instanceof Location) {
            Location s = (Location) a;
            return (world == null ? s.getWorld() == null : world.equals(s.getWorld().getName())) && s.getX() == x && s.getY() == y && s.getZ() == z && s.getPitch() == pitch && s.getYaw() == yaw;
        }
        return false;
    }
